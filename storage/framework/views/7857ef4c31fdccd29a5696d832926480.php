...
<nav>
    <div class="nav-inner">
        ...
        <div class="nav-links">
            <a href="<?php echo e(route('tenant.login')); ?>" class="btn-nav-login">
                <i class="bi bi-person-circle"></i> دخول الموظف
            </a>
            <a href="<?php echo e(route('super-admin.login')); ?>" class="btn-nav-login">
                <i class="bi bi-shield-lock"></i> دخول المدير
            </a>
            <a href="<?php echo e(route('register')); ?>" class="btn-nav-primary">
...
<section class="hero">
    <div>
        ...
        <div class="hero-buttons">
            <a href="<?php echo e(route('register')); ?>" class="btn-primary-hero">
                <i class="bi bi-rocket-takeoff"></i>
                ابدأ تجربتك المجانية
            </a>
            <a href="<?php echo e(route('tenant.login')); ?>" class="btn-secondary-hero">
...
<section class="pricing">
    ...
    <div class="pricing-grid">
        <div class="pricing-card">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-plan btn-plan-outline">ابدأ مجاناً</a>
        </div>
        ...
        <div class="pricing-card featured">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-plan btn-plan-filled">اشترك الآن</a>
        </div>
        ...
        <div class="pricing-card">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-plan btn-plan-outline">تواصل معنا</a>
        </div>
    </div>
</section>
...
<footer>
 ...
 <?php /**PATH C:\saas-messaging-complete\project\resources\views/welcome.blade.php ENDPATH**/ ?>